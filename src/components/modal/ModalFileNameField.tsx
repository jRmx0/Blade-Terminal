...
interface ModalFileNameFieldProps {
    label?: string;
    value: string;
    placeholder?: string;
...
const ModalFileNameField = forwardRef<HTMLInputElement, ModalFileNameFieldProps>(
...
ModalFileNameField.displayName = "ModalFileNameField";

export default ModalFileNameField;
