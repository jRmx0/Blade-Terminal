    ...
    return (
        <div className="flex items-center gap-2 px-3 h-8">
            ...
            <input
                ...
                className={`flex-1 min-w-0 border rounded bg-white text-xs px-2 h-6 focus:outline-none transition-colors placeholder:text-gray-300 ${isFocused ? "border-teal-700" : "border-gray-300"
